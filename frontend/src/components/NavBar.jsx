...
const NavBar = () => {
  ...
  return (
    <div className="primary-header container" data-width="wide">
      <div className="logo">
        <Link to="/">
      ...
      <button className="nav-toggle" aria-controls="primary-navigation" aria-expanded={navVisible} onClick={toggleNav}>
